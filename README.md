...
<head>
  ...
  <style>
    ...
    header, section, footer { padding: 2rem; max-width: 1000px; margin: auto; }
    header { text-align: center; background: #1a1a1a; color: #fff; padding: 4rem 2rem; }
    header h1 { font-size: 2.5rem; margin-bottom: 0.5rem; }
    header p { font-size: 1.2rem; margin: 0.3rem 0; }
    .skills span { display: inline-block; margin: 0.5rem; padding: 0.4rem 0.8rem; background: #e0e0e0; border-radius: 6px; font-size: 0.95rem; }
    .project { margin-bottom: 2rem; background: #fff; padding: 1rem; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.1); }
    .contact a { color: #0073b1; text-decoration: none; }
    footer { text-align: center; font-size: 0.9rem; color: #777; margin-top: 2rem; }
  </style>
</head>
<body>
  <header>
    ...
    <p><a href="#projects" style="color:#00aced; text-decoration:none; font-weight:bold;">See My Work ↓</a></p>
  </header>
